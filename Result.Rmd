...
AgeSystolicFig <- subplot(Systolic_rmse, Systolic_mae, Systolic_r2, nrows = 1, shareY = FALSE) %>%
  layout(title = list(text = "Figure 8: RMSE [Left], MAE [Middle], R² [Right] for Age Groups (Systolic)", 
                      font = list(size = 12)))
...
DiastolicFig <- subplot(Diastolic_rmse, Diastolic_mae, Diastolic_r2, nrows = 1, shareY = FALSE) %>%
  layout(title = list(text = "Figure 9: RMSE [Left], MAE [Middle], R² [Right] for Age Groups (Diastolic)", 
                      font = list(size = 12)))
...
SystolicFig <- subplot(Systolic_rmse, Systolic_mae, Systolic_r2, nrows = 1, shareY = FALSE) %>%
  layout(title = list(text = "Figure 12: RMSE [Left], MAE [Middle], R² [Right] for BMI Groups (Systolic)", 
                      font = list(size = 12)))
...
DiastolicFig <- subplot(Diastolic_rmse, Diastolic_mae, Diastolic_r2, nrows = 1, shareY = FALSE) %>%
  layout(title = list(text = "Figure 13: RMSE [Left], MAE [Middle], R² [Right] for BMI Groups (Diastolic)", 
                      font = list(size = 12)))
...
#### FiberEnergy
```{r bmi fiberenergy(Figure14), fig.width= 12, fig.height=14}
par(mfrow = c(3, 2))
...
#### CarbohydrateEnergy
```{r bmi carbohydrateenergy(Figure15), fig.width= 12, fig.height=14}
par(mfrow = c(3, 2))
carb_color <- "red"
...
colors_alcohol <- c('#F8766D', '#A3A500')
...
GenderSystolicFig <- subplot(Systolic_rmse, Systolic_mae, Systolic_r2, nrows = 1, shareY = FALSE) %>%
  layout(title = list(text = "Figure 20: RMSE [Left], MAE [Middle], R² [Right] for Gender Groups (Systolic)"), 
                      font = list(size = 12))
...
DiastolicFig <- subplot(Diastolic_rmse, Diastolic_mae, Diastolic_r2, nrows = 1, shareY = FALSE) %>%
  layout(title = list(text = "Figure 21: RMSE [Left], MAE [Middle], R² [Right] for Gender Groups (Diastolic)", 
                      font = list(size = 12)))
